...
import com.example.nearfule.databinding.ActivitySecondBinding
...
class second_activity : AppCompatActivity() {
    ...
    private fun getCityWeather(city: String) {
        ...
        ApiUtilities.getApiInterface()?.getCityWeatherData(city,apiKey)
            ?.enqueue(object : Callback<WM> {
                @RequiresApi(Build.VERSION_CODES.O)
                override fun onResponse(call: Call<WM>, response: Response<WM>) {
                    if (response.isSuccessful){

                        Toast.makeText(this@second_activity, "Wait..",
                        ...
                        Toast.makeText(this@second_activity, "No City Found",
                            Toast.LENGTH_SHORT).show()
                ...
                override fun onFailure(call: Call<WM>, t: Throwable) {
            ...
            when (id) {
                ...
                in 200..232 -> {
                    ...
                    mainLayout.background= ContextCompat
                        .getDrawable(this@second_activity, R.drawable.thunderstrom_bg)
                ...
                in 300..321 -> {
                    ...
                    mainLayout.background= ContextCompat
                        .getDrawable(this@second_activity, R.drawable.drizzle_bg)
                ...
                in 500..531 -> {
                    ...
                    mainLayout.background= ContextCompat
                        .getDrawable(this@second_activity, R.drawable.rain_bg)
                ...
                in 600..622 -> {
                    ...
                    mainLayout.background= ContextCompat
                        .getDrawable(this@second_activity, R.drawable.snow_bg)
                ...
                in 701..781 -> {
                    ...
                    mainLayout.background= ContextCompat
                        .getDrawable(this@second_activity, R.drawable.atmosphere_bg)
                ...
                800 -> {
                    ...
                    mainLayout.background= ContextCompat
                        .getDrawable(this@second_activity, R.drawable.clear_bg)
                ...
                in 801..804 -> {
                    ...
                    mainLayout.background= ContextCompat
                        .getDrawable(this@second_activity, R.drawable.clouds_bg)
                    ...
                    mainLayout.background= ContextCompat
                        .getDrawable(this@second_activity, R.drawable.unknown_bg)
